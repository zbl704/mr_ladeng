...
public class ClipUtil {
	...
	public static void clipVideo(String path, double begin, double end) throws IOException {
		String mp4Path =	Environment.getExternalStorageDirectory() + "/Wish/"+String.valueOf(System.currentTimeMillis())+".mp4";
		File mSdCardDir = Environment.getExternalStorageDirectory();
		//File f = new File(mSdCardDir.getAbsolutePath() + File.separator + Util.SAVE_PATH);
		File f = new File(mSdCardDir.getAbsolutePath() + File.separator + mp4Path);
